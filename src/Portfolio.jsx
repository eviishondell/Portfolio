  ...
  return (
    <div className="snap-y snap-mandatory overflow-y-scroll h-screen bg-stone-100 font-sans" style={{ fontFamily: '-apple-system, BlinkMacSystemFont, "SF Pro Display", "SF Pro Text", system-ui, sans-serif' }}>
                ...
                {carouselSlides.map((slide) => (
                  <div key={slide.id} className="w-full flex-shrink-0">
                    <div className="w-full">
                      ...
                      <div className="bg-gradient-to-br from-stone-200 to-stone-300 rounded-lg aspect-[16/9] flex items-center justify-center text-stone-600 text-2xl font-medium shadow-lg">
        ...
        <div className="h-screen flex flex-col justify-center">
          <div className="max-w-6xl mx-auto px-6 w-full">
            ...
            <div className="grid md:grid-cols-2 gap-16">
              ...
              <div className="bg-gradient-to-br from-stone-300 to-stone-400 rounded-lg aspect-square flex items-center justify-center text-stone-600 text-xl font-medium shadow-lg">
                Profile Image
              </div>
              ...
              <div className="max-w-md">
                ...
                <div>
                  <button className="bg-black text-white px-8 py-3 rounded-full hover:bg-stone-800 transition">
                    Learn More.
                  </button>
                </div>
              </div>
      ...
      <section className="bg-white snap-start snap-always min-h-screen">
        <div className="h-screen flex flex-col justify-center">
          <div className="max-w-6xl mx-auto px-6 w-full">
            <h2 className="text-4xl font-bold mb-16">Media Appearances.</h2>
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-12">
              {mediaAppearances.map((item, idx) => (
                ...
                >
                  {/* Placeholder Image */}
                  <div className="absolute inset-0 bg-gradient-to-br from-stone-700 to-stone-900 flex items-center justify-center text-white text-sm">
                    {item.image}
                  </div>
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent flex flex-col justify-between p-6">
                    ...
                    {/* Arrow Icon */}
                    <div className="self-end bg-white rounded-full w-10 h-10 flex items-center justify-center group-hover:scale-110 transition">
            ...
            <div className="flex justify-center gap-4">
              <button className="w-10 h-10 rounded-full border border-stone-300 flex items-center justify-center hover:bg-stone-100 transition">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" />
                </svg>
              </button>
              <button className="w-10 h-10 rounded-full bg-stone-900 text-white flex items-center justify-center hover:bg-stone-800 transition">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
